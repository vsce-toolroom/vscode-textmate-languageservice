...
// Reserved (r) MIT License - see ./LICENSE.md.
...
function peg$parse(input: string, options?: ParseOptions) {
  ...
  function peg$parsecomposite(): matchers.GroupMatcher | matchers.NegateMatcher | matchers.GroupMatcher | matchers.PathMatcher {
    let s0, s1, s2, s3, s4, s5;
