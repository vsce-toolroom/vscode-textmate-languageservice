...
export type Expression = matchers.NegateMatcher | matchers.GroupMatcher | matchers.PathMatcher;
export type Composite = matchers.GroupMatcher | matchers.NegateMatcher | matchers.GroupMatcher | matchers.PathMatcher;
